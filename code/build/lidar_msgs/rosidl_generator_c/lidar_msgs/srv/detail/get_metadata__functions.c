  ...
  lidar_msgs__srv__GetMetadata_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    lidar_msgs__srv__GetMetadata_Request * data =
      (lidar_msgs__srv__GetMetadata_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lidar_msgs__srv__GetMetadata_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          lidar_msgs__srv__GetMetadata_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  lidar_msgs__srv__GetMetadata_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    lidar_msgs__srv__GetMetadata_Response * data =
      (lidar_msgs__srv__GetMetadata_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lidar_msgs__srv__GetMetadata_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          lidar_msgs__srv__GetMetadata_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
