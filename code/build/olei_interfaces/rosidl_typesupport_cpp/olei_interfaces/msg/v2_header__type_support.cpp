...
static const _V2Header_type_support_symbol_names_t _V2Header_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, olei_interfaces, msg, V2Header)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, olei_interfaces, msg, V2Header)),
  }
};
...
{
  return &::olei_interfaces::msg::rosidl_typesupport_cpp::V2Header_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, olei_interfaces, msg, V2Header)() {
  return get_message_type_support_handle<olei_interfaces::msg::V2Header>();
}
