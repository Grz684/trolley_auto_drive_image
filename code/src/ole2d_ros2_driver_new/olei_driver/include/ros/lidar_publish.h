...
private:
    ...
    void publish_pointcloud(sensor_msgs::msg::LaserScan::SharedPtr msg);
    sensor_msgs::msg::PointCloud2 convertToPointCloud2(sensor_msgs::msg::LaserScan::SharedPtr scan);
};
