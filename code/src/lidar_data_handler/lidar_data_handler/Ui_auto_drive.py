...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.back_lidar_widget.getViewBox().setMouseEnabled(x=False, y=False)
        self.back_lidar_widget.getViewBox().setMenuEnabled(False)
        ...
        self.front_lidar_widget.getViewBox().setMouseEnabled(x=False, y=False)
        self.front_lidar_widget.getViewBox().setMenuEnabled(False)
